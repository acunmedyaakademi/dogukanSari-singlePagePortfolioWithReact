...
function Header() {
  return (
    <div className="header">
      <a href="#"><img src="../public/Images/mobilelogo.svg" alt="Logo" /></a>
...
function ContainerContent() {
  return(
    <div className="content-container">
      <div className="content"><img src="../public/Images/graphicdeign-img.png"/>Graphic Design</div>
      <div className="content tek"><img src="../public/Images/uiux-img.png"/>UI/UX</div>
      <div className="content tek"><img src="../public/Images/apps-img.png"/>Apps</div>
      <div className="content"><img src="../public/Images/Illustrations-img.png"/>Illustrations</div>
      <div className="content"><img src="../public/Images/photography-img.png"/>Photography</div>
      <div className="content"><img src="../public/Images/motiongraphic-img.png"/>Motion Graphics</div>
    </div>
  )
}
...
function AboutMe() {
  return(
    <div className="about-me">
      <img src="../public/Images/aboutme-img.png" alt="Amy" />
...
function Footer() {
  return(
    <div className="footer">
      <a href="/index.html"><img src="../public/Images/mobilelogo.svg" alt="Logo" /></a>
      <a href="#" className="header-btn">Free Consultation</a>
    </div>
  )
}
