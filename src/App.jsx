...
function Header() {
  return (
    <div className="header">
      <a href="#"><img src="../public/mobilelogo.svg" alt="Logo" /></a>
...
function ContainerContent() {
  return(
    <div className="content-container">
      <div className="content"><img src="../public/graphicdeign-img.png"/>Graphic Design</div>
      <div className="content tek"><img src="../public/uiux-img.png"/>UI/UX</div>
      <div className="content tek"><img src="../public/apps-img.png"/>Apps</div>
      <div className="content"><img src="../public/Illustrations-img.png"/>Illustrations</div>
      <div className="content"><img src="../public/photography-img.png"/>Photography</div>
      <div className="content"><img src="../public/motiongraphic-img.png"/>Motion Graphics</div>
    </div>
  )
}
...
function AboutMe() {
  return(
    <div className="about-me">
      <img src="../public/aboutme-img.png" alt="Amy" />
...
function Footer() {
  return(
    <div className="footer">
      <a href="/index.html"><img src="../public/mobilelogo.svg" alt="Logo" /></a>
      <a href="#" className="header-btn">Free Consultation</a>
    </div>
  )
}
